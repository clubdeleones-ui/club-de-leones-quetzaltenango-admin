...
export const ProgramaFuturo: React.FC = () => {
  ...
  const acronymLetters = [
    ...
    },
    {
      ...
      iconColor: 'bg-yellow-500 text-blue-955'
    },
    {
      letter: 'T',
      word: 'Tecnológicas',
  ...
  const modules = [
    ...
    },
    {
      ...
      icon: Code,
      color: 'border-cyan-500/30 bg-cyan-50/50',
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12 font-sans">
      ...
      <div className="bg-gradient-to-br from-blue-955 via-blue-900 to-slate-900 rounded-[2.5rem] p-8 sm:p-14 shadow-2xl text-white relative overflow-hidden border border-blue-800/40">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 pt-2">
            <a
              ...
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-400 hover:to-amber-400 text-blue-955 font-black px-6 py-3.5 rounded-2xl text-xs sm:text-sm transition-all shadow-lg shadow-yellow-500/10 hover:scale-105 active:scale-95"
            >
              <School size={16} />
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 bg-white/10 hover:bg-white/20 text-white font-bold px-5 py-3.5 rounded-2xl text-xs sm:text-sm transition-all border border-white/15 backdrop-blur-md"
            >
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 bg-emerald-600/30 hover:bg-emerald-600/40 text-emerald-300 font-bold px-5 py-3.5 rounded-2xl text-xs sm:text-sm transition-all border border-emerald-500/30"
            >
          ...
          {acronymLetters.map((item, idx) => (
            ...
            >
              <div className="flex items-center space-x-3.5">
                <div className={`w-12 h-12 rounded-2xl ${item.iconColor} font-black text-xl flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform`}>
                  {item.letter}
                </div>
                <div>
